...
if __name__ == '__main__':
    ...
    # model.create_item("Films", ['f_name', 'release_year'], ['film1', 2020])
    # model.create_items("Films", ['f_name', 'release_year'], [['film4', 2020], ['film5', 2020]])
    # print(model.read_items('Films', ['f_name', 'f_genre']))
    # print(model.read_item('Films', ['f_name', 'f_genre'], 3))
    # model.delete_item('Films', 4)
